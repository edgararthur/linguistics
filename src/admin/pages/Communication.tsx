...
import { MessageSquare, Mail, Send, Plus, Loader, Users, Phone, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function Communication() {
  ...
  const handleSendSMS = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send Broadcast
      // If it's a large list, we might want to batch it, but smsService handles basic array.
      // Ideally, the backend or service should handle batching if the provider has limits.
      // For now, we assume the service or provider handles the array.
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-blue-700 mt-1">
                                Messages are sent via mNotify. Ensure your account has sufficient credit.
